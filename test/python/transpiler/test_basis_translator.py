...
from qiskit.transpiler.passes.synthesis import SynthesizeUnitaries
...
# KDK Merge these into unroller.py
class TestUnrollerCompatability(QiskitTestCase):
    ...
    def test_definition_unroll_parameterized_with_expressions(self):
        ...
        with self.assertRaisesRegex(QiskitError, 'unsupported') as e:
            pass_ = SynthesizeUnitaries(std_eqlib)
            dag = pass_.run(dag)
